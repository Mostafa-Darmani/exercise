...
export default function ClassSelector() {
  ...
  return (
    <div className="w-[450px] mx-auto bg-[#F9FBFF] min-h-screen pb-10 relative">
      {/* هدر بالا */}
      <div className="flex flex-col gap-5 bg-white shadow-md p-5 rounded-b-3xl">
        {/* استپر */}
      ...
      {/* آمار بالای لیست */}
      <div className="bg-gray-200 flex items-center justify-between p-1.5 mt-10 px-7">
        <div className="flex items-center gap-1">
          <span className="p-1 bg-blue-700 rounded-full ml-2 mt-1"></span>
          <span className="text-gray-400">کل کاربران</span>
          <span className="text-black font-semibold">{totalStudents}</span>
          <span className="text-gray-400">نفر</span>
        </div>
        <div className="flex items-center gap-1">
          <ArrowIcon />
      ...
      {/* لیست کلاس‌ها */}
      <div className="flex flex-col gap-5 mt-3.5 relative">
        {filteredClasses.map((cls) => (
          ...
          >
            ...
            {openClass === cls.id && (
              <div
                className="flex flex-col pt-10 border-r border-dashed border-gray-400"
                style={{
        ...
        {selectedStudents.length > 0 && (
          <div className="fixed bottom-15 left-15 max-w-md">
